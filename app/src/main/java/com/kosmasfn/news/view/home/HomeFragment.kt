...
import com.kosmasfn.news.databinding.FragmentHomeBinding
...
class HomeFragment : BaseFragment<FragmentHomeBinding>() {
    ...
    private var sources: String = "android"
    private var page = 1
    ...
    private fun initAdapter(data: NewsDomainModel) {
        with(getViewBinding().rvArticles) {
            ...
            setEndlessScrollListener {
                page += 1
                viewModel.fetchArticle(sources, page)
            }
        }
    }
    ...
    private fun onTextSearchEnterPressed(q: String) {
        page = 1
        viewModel.fetchArticle(source = q, page)
    }
